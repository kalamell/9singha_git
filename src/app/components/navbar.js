...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-[#fee042] drop-shadow-[0_1px_3px_rgba(0,0,0,0.20)] px-6 max-md:px-5">
        <div className="container mx-auto">
          <div className="flex justify-between py-[7px] max-md:py-[12px]">
            ...
            <div className="flex items-center gap-x-3 ">
              <p className="font-athitiSemiBold text-[#984333] text-base max-md:hidden">
                สนใจทำประกัน โทร.
                <span className="underline">
                  <Link href="tel:022759119">02-275-9119</Link>
                </span>
              </p>
              ...
              <button
                type="button"
                onClick={handleClick}
                className="bg-white max-md:bg-[#984333] max-md:border-[#984333] border-white border-2 rounded-[32px] font-athitiSemiBold text-sm flex gap-x-1.5 items-center px-[18px] py-[6px] text-[#984333] max-md:text-[#FFFFFF] hover:border-[#984333]  transition-all duration-300 ease-in-out"
              >
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 16 14"
                  fill="none"
                  className="stroke-[#984333] max-md:stroke-[#FFFFFF] 
              "
                >
                  <path
              ...
              {user ? (
                ...
                <Link href={`/login`}>
                  <button
                    type="button"
                    className="rounded-[32px] transition duration-500 font-athitiSemiBold text-sm flex px-[20px] py-[8px] bg-[#984333] text-white hover:bg-[#181b31] max-md:hidden"
                  >
                    เข้าสู่ระบบ
                  </button>
                </Link>
